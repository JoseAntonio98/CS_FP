...
const Mapa: React.FC<ContainerProps> = (props) => {
  ...
  return (
    ...
    : <iframe width="600" height="450" style={{border:0}} loading="lazy" src={`https://www.google.com/maps/embed/v1/directions?origin=${props.o_lat}${props.o_lon}&destination=${props.d_lat}${props.d_lon}&key=AIzaSyD1TBUdvLxAsChqd_ruQSjvQ1FkHLVdjG0&maptype=satellite`}></iframe>
  )
}
